...
RSpec.describe 'The Merchant Dashboard' do
  before :each do
    ...
    @invoice_item3 = InvoiceItem.create!(item_id: @item3.id, invoice_id: @invoice3.id, quantity: 4, unit_price: 100, status: 1)
  end
  ...
  it "displays the top_five_customers names and number of orders" do
    ...
    @item1 = Item.create!(name: 'food', description: 'delicious', unit_price: '2000', merchant_id: @katz.id)
    @item2 = Item.create!(name: 'more food', description: 'even more delicious', unit_price: '3000', merchant_id: @katz.id)
