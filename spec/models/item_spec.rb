  ...
  describe 'instance methods' do
    describe '.best_discount' do
      it 'returns the possible discount for the item' do
        ...
        discount1 = merchant1.discounts.create(percentage_discount: 5, quantity_threshold: 5)
        discount2 = merchant1.discounts.create(percentage_discount: 50, quantity_threshold: 50)

        expect(item.best_discount).to eq(@discount2)
      end
    end
  end
end
